...
Follow the [Git Commit Message Guide](../instructions/workflow/commit-message.instructions.md) for comprehensive instructions on code analysis, message formatting, and JIRA number requirements.