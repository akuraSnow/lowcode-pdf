...
## PROJECT CONTEXT
- Project Type: [Angular|React|Vue|Next.js] (auto-detect)
  * Auto-detection Rules:
    - Angular: package.json contains '@angular/core' OR files with '.module.ts' extension exist
    - React: package.json contains 'react' OR files with '.jsx/.tsx' extensions exist
    - Vue: package.json contains 'vue' OR files with '.vue' extensions exist
    - Next.js: package.json contains 'next' OR next.config.js exists
- Testing Framework Auto-Selection:
  * Angular: Jasmine + Karma (default) OR Jest (if @jest configured)
  * React: Jest + React Testing Library (default) OR Vitest (if vitest configured)
  * Vue: Vue Test Utils + Jest (default) OR Vitest
  * Next.js: Jest + React Testing Library

## CODING STANDARDS
### Angular:
- UpperCamelCase for classes/types/interfaces
- lowerCamelCase for variables/functions/methods
- CONSTANT_CASE for constants and enums
- Observables end with $ suffix
- Test files: component-name.component.spec.ts
- Mock services with jasmine.createSpy() or jest.fn()
...
- Test files: ComponentName.spec.js or component-name.spec.js
- Use Vue Test Utils mount/shallowMount
...
### Hook Testing (React/Vue - Priority 2):
