...
import PluginResourceManagement from './plugins/plugin-resource-management';
...
async function registerPlugins() {
  ...
  await plugins.register(PluginResourceManagement);
  await plugins.register(PluginDocumentExport);
  await plugins.register(PluginDataManagement);
  
  // 注册发布插件
  await plugins.register(PublishPlugin);
  
  // 注册模板管理插件
  await plugins.register(TemplateManagerPlugin);
